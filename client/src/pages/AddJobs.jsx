  ...
  return (
    <form onSubmit={onSubmitHandler} className='container flex flex-col p-4 w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <input onChange={e => setTitle(e.target.value)} value={title} type="text" placeholder='Type here' required className='w-full max-w-lg px-3 py-2 border-2 border-gray-300 rounded'/>
      </div>
      ...
      <div>
        ...
        <input min={0} className='w-full px-3 py-2 border-2 border-gray-300 rounded sm:w-[120px]' onChange={e => setSalary(e.target.value)} value={salary} type="Number" placeholder='25000' />
      </div>

      <button className='w-28 py-3 mt-4 text-white bg-emerald-500 rounded' type='submit'>ADD</button>
